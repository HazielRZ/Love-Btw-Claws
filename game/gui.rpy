...
## El color enfatizado usado en la interfaz para subrayar texto (Naranja "Laws").
define gui.accent_color = '#FF8534'

## El color del botón de texto cuando no está seleccionado ni enfocado (Azul contorno).
define gui.idle_color = '#329EC2'

## El color 'small' se usa para el texto pequeño, que necesita destacar más (Azul "Love").
define gui.idle_small_color = '#59CEEB'

## El color usado en botones y barras que ganan foco (Rojo Cangrejo).
define gui.hover_color = '#EF4A53'

## El color del botón de texto seleccionado pero no enfocado.
define gui.selected_color = '#FF8534'

## El color de los botones de texto que no pueden ser seleccionados
define gui.insensitive_color = '#B3E1E87f'

## Colores de la parte vacía de las barras.
define gui.muted_color = '#B3E1E8'
define gui.hover_muted_color = '#59CEEB'

## Colores del texto del diálogo y menú.
define gui.text_color = '#174A5C'
define gui.interface_text_color = '#174A5C'
